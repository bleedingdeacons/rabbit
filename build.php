...
/**
 * Build Script for Rabbit WordPress Plugin
 *
...
class PluginBuilder
{
    ...
    private string $pluginName = 'rabbit';
    private string $mainFile = 'rabbit.php';
    private string $versionConstant = 'RABBIT_VERSION';
...
Rabbit WordPress Plugin Build Script
=======================================
Platform: {$platform}
